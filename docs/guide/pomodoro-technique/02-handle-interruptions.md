...
> 记录入口与控件名称以 [任务追踪](../reference/task.md)、[附录：按钮一览](../appendix/buttons.md) 为准。
...
在番茄计时过程中，按界面提示打开记录流程（见 [番茄时钟](../reference/timer.md)），其中包含打断记录功能。
...
1. **计时过程中被打断**
   - 不要停止计时器
   - 快速在便签/纸上记下打断内容
   - 若在软件内记录，按番茄时钟 / 任务追踪相关控件操作（见 reference）
