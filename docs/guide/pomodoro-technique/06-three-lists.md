...
> 界面分区与字段名以 [软件界面](../reference/interface.md)、[活动清单](../reference/activity.md)、[计划表](../reference/planner.md)、[任务追踪](../reference/task.md) 为准；清单与计划、追踪、时间表之间如何流动见 [模块联动](../reference/workflow.md)。
...
- **活动清单**是总仓库（右侧面板）
- **计划表**承载「今日待办」与计划侧视图（中间偏上），并与实际执行对照
...
**位置**：首页中间偏上**计划表区**（见 [计划表](../reference/planner.md)）
...
- 番茄完成、记录流程的结果会反映到计划表与活动状态（见 [任务追踪](../reference/task.md)、[番茄时钟](../reference/timer.md)）
...
- 计划列与完成状态以日 / 周 / 月视图为准（见 [计划表](../reference/planner.md)）
...
| -------- | -------- | ------------------------------ | ------------------------ |
| 活动清单 | 一张纸张 | 活动清单视图                   | 右侧                     |
| 今日待办 | 一张纸张 | 计划表视图（计划侧）           | 中间偏上                 |
| 当日记录 | 一张纸张 | 计划表对照 + 任务追踪 + 数据页 | 中间 / 数据页            |
