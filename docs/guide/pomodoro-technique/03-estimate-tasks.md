...
> 预估字段与分段规则以 [活动清单](../reference/activity.md)、[计划表](../reference/planner.md) 为准。
...
**位置**：计划表视图中的任务卡片（见 [计划表](../reference/planner.md)）
