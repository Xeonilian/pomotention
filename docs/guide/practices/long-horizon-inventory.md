...
4. 更完整的 **目标 / 不做清单 / 第 7 天砍 scope** 可写在 dev-log：活跃关用 [`current.md`](../../dev-log/current.md)，长一点的一次性备忘放 [`meta/notes/`](../../dev-log/meta/notes/)（示例：[`timer-14d-anchor.md`](../../dev-log/meta/notes/timer-14d-anchor.md)），与软件内 backlog 互补。
...
若实现上述能力，会在 [更新日志](../../dev-log/CHANGELOG.md) 与 [开发地图](../intro/roadmap.md) 中说明；构想细节见 [`dev-log/meta/notes/vision.md`](../../dev-log/meta/notes/vision.md)。本文操作步骤 **仍以当前版本为准**。
