      ...
      sidebar: [
        {
          text: "简介",
          items: [
            { text: "什么是Pomotention？", link: "/guide/intro/what-is-pomotention" },
            {
              text: "快速开始",
              link: "/guide/intro/getting-started",
              items: [
                { text: "桌面客户端", link: "/guide/intro/pc-getting-started" },
                { text: "PWA网页应用", link: "/guide/intro/pwa-getting-started" },
              ],
            },
            { text: "快速使用", link: "/guide/intro/get-things-done" },
        ...
        },
        {
          ...
          items: [
            ...
            { text: "活动清单", link: "/guide/reference/activity" },
            {
              text: "任务计划",
              items: [
                { text: "信息导航", link: "/guide/reference/ics" },
